...
raw_hosts = env("DJANGO_ALLOWED_HOSTS", "localhost,127.0.0.1")
...
WSGI_APPLICATION = "nkap.wsgi.application"


database_engine = env("DATABASE_ENGINE", "sqlite3").lower()
if database_engine in {"postgres", "postgresql"}:
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.postgresql",
            "NAME": env("POSTGRES_DB", "nkap"),
            "USER": env("POSTGRES_USER", "nkap"),
            "PASSWORD": env("POSTGRES_PASSWORD", "nkap"),
